    ...
    <section id="portfolio" class="portfolio" data-aos="fade-up">
                ...
                <div class="row g-0 portfolio-container">
                    ...
                    for ($i = 1; $i <= 8; $i++) {
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item">
                            <img src="./images/gallery/<?php echo $objResult['atv_img'.$i];?>" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>ภาพ <?php echo $i;?></h4>
                                <a href="./images/gallery/<?php echo $objResult['atv_img'.$i];?>" title="App <?php echo $i;?>" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <?php while ($objResult_s = mysqli_fetch_array($objQuery_s, MYSQLI_ASSOC)) { ?>
                <div class="swiper-slide"><a href="activity.php?id=<?php echo $objResult_s["atv_id"];?>"><img src="./images/gallery/<?php echo $objResult_s["atv_img1"];?>" class="img-fluid" alt=""></a></div>
            <?php } ?>
            </div>

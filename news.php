                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <ul class="nav nav-tabs flex-column">
                        ...
                        while ($objResult = mysqli_fetch_array($objQuery, MYSQLI_ASSOC)) {
                            ...
                            // ตรวจสอบว่า n_id เท่ากับ 1 หรือไม่
                            if ($objResult['n_id'] == 1) {
                                $activeShowClass = 'active show'; // กำหนด class เป็น 'active show' ถ้า n_id เท่ากับ 1
                            }
                        ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo $activeShowClass; ?>" data-bs-toggle="tab" data-bs-target="#tab-<?php echo $counter; ?>">
                                    <h4><?php echo $objResult['n_name'];?></h4>
                                    <!-- <p><?php echo $objResult['n_title'];?></p> -->
                                </a>
                            </li>
                        <?php
                ...
                <div class="col-lg-8">
                    ...
                    <?php
                        ...
                        while ($objResult_s = mysqli_fetch_array($objQuery_s, MYSQLI_ASSOC)) {
                            ...
                            // ตรวจสอบว่า n_id เท่ากับ 1 หรือไม่
                            if ($objResult_s['n_id'] == 1) {
                                $activeShowClass = 'active show'; // กำหนด class เป็น 'active show' ถ้า n_id เท่ากับ 1
                            }
                    ?>
                            <div class="tab-pane <?php echo $activeShowClass; ?>" id="tab-<?php echo $counter; ?>">
                                <!-- <h3><?php echo $objResult_s['n_title'];?></h3> -->
                                <img src="./images/meet/<?php echo $objResult_s['n_img'];?>" alt="" style="max-width: 850px">
                            </div>
                    <?php
                            $counter++; // เพิ่มค่าตัวแปรนับค่าเมื่อจบลูป
                        }

...
<div class="dropdown p-2 link-secondary">
    ...
    <div class="dropdown-content location">
        <a href="#" id="address-link"><i class="fa-solid fa-house" style="color: #005eff;">&nbsp;&nbsp;</i>ที่อยู่ :  57 ถ.ไสน้ำเย็น ต.ป่าตอง อ.กะทู้ จ.ภูเก็ต 83150 <br>
        Patong Hospital : 57 sainamyen Rd., Patong, Kathu, Phuket 83150 Thailand</a>
        <a href="#"><i class="fa-solid fa-phone" style="color: #005eff;"></i>&nbsp;&nbsp;เบอร์โทร : 076-342 633-4</a>
        <a href="#"><i class="fa-solid fa-tty" style="color: #005eff;"></i>&nbsp;&nbsp;Fax : 076-340 617</a>
